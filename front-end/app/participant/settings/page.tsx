  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Note: Backend returns allow_marketing, but we need to check the actual response structure
    ...
    <div className="min-h-screen bg-[#f8f8ff] text-[#0f172a] flex">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 px-6 py-8 flex flex-col">
        ...
        <nav className="flex flex-col gap-3 text-[#475569] font-figtree">
          ...
          <Link href="/participant/settings" className="flex items-center gap-3 px-3 py-2 rounded-xl bg-[#EFEAFF] text-[#5425FF] font-semibold">
