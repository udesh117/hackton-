      ...
      <main className="flex-1 px-8 py-8 space-y-6 overflow-y-auto">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[#64748b] font-figtree mt-1">Announcements and important updates for judges</p>
          </div>
          {unreadCount > 0 && (
            <button
        ...
        {notifications.length === 0 ? (
          <div className="bg-white rounded-2xl p-12 shadow-sm border border-gray-100 text-center">
            ...
            <p className="text-[#64748b] font-figtree">You're all caught up. Check back later.</p>
          </div>
        ) : (
            ...
            {notifications.map((notification) => (
              <div
                ...
                className={`bg-white rounded-2xl p-6 shadow-sm border transition-all ${
                  notification.is_read ? 'border-gray-200 opacity-75' : 'border-[#5425FF]/30 bg-[#EFEAFF]/30'
                }`}
              >
                  ...
                  <div className="flex-1">
                    <div className="flex items-start gap-3 mb-2">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[#475569] font-figtree mb-3 whitespace-pre-wrap">{notification.content}</p>
